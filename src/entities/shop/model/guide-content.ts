...
export const GUIDES: GuideContent[] = [
  ...
  },
  {
    ...
    boundary:
      "이에케·지로계는 돈코츠쇼유 국물을 쓰는 '스타일'이지 돈코츠쇼유와 같은 말이 아닙니다. 돈코츠 라멘 다수도 타레는 간장이라 '간장 사용 여부'로는 구분되지 않습니다.",
    sources: [
      {
        name: `${JAWIKI} 家系ラーメン`,
  ...
  },
  {
    slug: "iekei",
    intro: [
      "1974년 요코하마 吉村家에서 시작한 스타일입니다. '규슈 돈코츠 + 도쿄 간장'을 합친 진한 돈코츠쇼유 국물에 닭기름(鶏油), 중태 스트레이트면, 시금치·사각 김 3장·챠슈가 정석이고, 밥과 함께 먹는 문화가 붙어 있습니다.",
      "주문 시 면 굳기·맛 농도·기름 양을 지정하는 방식이 이 스타일의 관례입니다.",
    ],
    origin:
    ...
    boundary:
      "국물 종류가 아니라 스타일입니다(국물은 돈코츠쇼유). 吉村家 계열의 直系와 체인형 資本系로 나뉩니다.",
    sources: [
      {
        name: `${JAWIKI} 家系ラーメン`,
        url: "https://ja.wikipedia.org/wiki/家系ラーメン",
  ...
  },
  {
    slug: "jiro",
    intro: [
      "1968년 山田拓美가 시작한 ラーメン二郎를 따르는 스타일입니다. 돈코츠 베이스 간장맛에 극태 평타면, 숙주·양배추 산, 두툼한 煮豚, 마늘, 등지방 — '라멘이 아니라 지로라는 음식'이라 불릴 만큼 독자적입니다.",
    ...
    boundary:
      "국물 장르가 아닌 스타일입니다. 본점 수행을 거친 直系와 스타일만 따르는 インスパイア系로 나뉩니다.",
    sources: [
      {
        name: `${JAWIKI} ラーメン二郎`,
